...
5. Los tiempos de entrega son estimados y pueden variar.`,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="!max-w-[95vw] sm:!max-w-[95vw] md:!max-w-[90vw] lg:!max-w-[85vw] xl:!max-w-[80vw] w-[95vw] max-h-[90vh] overflow-y-auto bg-bg-primary text-text-primary">
        <DialogHeader>
          <DialogTitle>
