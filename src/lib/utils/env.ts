 ...
 * 
 * Estrategia:
 * 1. Usa NEXT_PUBLIC_APP_URL si está configurada y es correcta (incluye 'eagles')
...
export function getAppUrl(): string {
  ...
  if (nextPublicUrl && nextPublicUrl.includes('eagles')) {
  ...
  // Último fallback
  return nextPublicUrl || 'https://eagles.vercel.app';
}
