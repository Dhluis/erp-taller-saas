...
export function detectUserCountry(): CountryCode {
  ...
  const detected = Object.entries(tzMap).find(([city]) =>
  ...
  if (country === "US") {
    ...
    else if (tzLower.includes("bogota"))
      country = "MX"; // Mapeo temporal
    else if (tzLower.includes("buenos_aires") || tzLower.includes("argentina"))
      country = "AR";
    else if (tzLower.includes("santiago") || tzLower.includes("chile"))
      country = "CL";
    else if (tzLower.includes("lima") || tzLower.includes("peru"))
      country = "PE";
    else if (tzLower.includes("montevideo") || tzLower.includes("uruguay"))
      country = "UY";
