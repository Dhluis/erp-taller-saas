...
export const PRICING_BY_COUNTRY = {
  MX: {
    monthly: {
      ...
      mercadopagoTitle: 'Plan Mensual Premium - Eagles ERP',
    },
    annual: {
      amount: 24091,
      currency: 'MXN',
      ...
      mercadopagoTitle: 'Plan Anual Premium - Eagles ERP',
  ...
  BR: {
    monthly: {
      ...
      mercadopagoTitle: 'Plano Mensal Premium - Eagles ERP',
    },
    annual: {
      amount: 8120,
      currency: 'BRL',
      displayPrice: 'R$8,120 BRL',
      mercadopagoTitle: 'Plano Anual Premium - Eagles ERP',
  ...
  US: {
    monthly: {
      ...
      mercadopagoTitle: 'Premium Monthly - Eagles ERP',
    },
    annual: {
      ...
      mercadopagoTitle: 'Premium Annual - Eagles ERP',
