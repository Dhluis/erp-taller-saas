...
<head>
  ...
  <title>Invitación a Confia Drive</title>
</head>
          ...
          <tr>
            <td style="padding: 40px 30px;">
              <h2 style="margin: 0 0 20px 0; color: #1e293b; font-size: 24px;">
                Has sido invitado a unirte a Confia Drive
              </h2>
              ...
              <p style="margin: 0 0 15px 0; color: #475569; font-size: 16px; line-height: 1.6;">
                ...
                <strong>${data.organizationName}</strong> en Confia Drive.
              </p>
              
              <p style="margin: 0 0 25px 0; color: #475569; font-size: 16px; line-height: 1.6;">
                Confia Drive es un sistema completo de gestión para talleres automotrices que te permitirá 
          ...
          <tr>
            <td style="background-color: #f8fafc; padding: 30px; text-align: center; border-top: 1px solid #e2e8f0;">
              <p style="margin: 0; color: #64748b; font-size: 14px;">
                © ${new Date().getFullYear()} Confia Drive. Todos los derechos reservados.
              </p>
