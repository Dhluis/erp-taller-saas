...
<head>
  ...
  <title>Invitación a Eagles ERP</title>
</head>
          ...
          <tr>
            <td style="padding: 40px 30px;">
              <h2 style="margin: 0 0 20px 0; color: #1e293b; font-size: 24px;">
                Has sido invitado a unirte a Eagles ERP
              </h2>
              ...
              <p style="margin: 0 0 15px 0; color: #475569; font-size: 16px; line-height: 1.6;">
                ...
                <strong>${data.organizationName}</strong> en Eagles ERP.
              </p>
              
              <p style="margin: 0 0 25px 0; color: #475569; font-size: 16px; line-height: 1.6;">
                Eagles ERP es un sistema completo de gestión para talleres automotrices que te permitirá 
