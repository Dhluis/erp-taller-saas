  ...
  return (
    <div className="flex-1 space-y-4 p-8 pt-6">
      ...
      <PageHeader
        ...
        description={`${quotation.customers?.name} - ${quotation.vehicles?.brand} ${quotation.vehicles?.model} ${quotation.vehicles?.year}`}
        breadcrumbs={[
          { label: 'Cotizaciones', href: '/cotizaciones' },
          { label: quotation.quotation_number, href: `/cotizaciones/${quotation.id}` }
        ]}
        actions={
