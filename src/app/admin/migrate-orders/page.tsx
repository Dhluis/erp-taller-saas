...
export default function MigrateOrdersPage() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold text-white mb-6">Migración de Órdenes</h1>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-slate-800 rounded-lg p-6 border border-slate-700">
          ...
          <ul className="space-y-2 text-slate-300">
            <li>• Actualiza todas las órdenes con el organization_id antiguo</li>
            <li>• Las actualiza al organization_id correcto de tu usuario</li>
            <li>• Esto permite que todas las órdenes aparezcan correctamente</li>
