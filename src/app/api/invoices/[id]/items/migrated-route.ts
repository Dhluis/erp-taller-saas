/**
 * API Route Migrada para Items de Notas de Venta
 * 
...
// =====================================================
// GET - Obtener items de nota de venta (MIGRADO)
// =====================================================
...
// =====================================================
// POST - Crear item de nota de venta (MIGRADO)
// =====================================================
 ...
 *    - A: '@/lib/api/invoice-items-migration'
 * 
 * 3. Reemplaza las funciones:
 *    - getInvoiceItems() → getInvoiceItemsWithLogging()
 *    - createInvoiceItem() → createInvoiceItemWithLogging()
 * 
