/**
 * API Route Migrada para Crear Cotización desde Orden de Trabajo
 * 
...
// =====================================================
// POST - Crear cotización desde orden de trabajo (MIGRADO)
// =====================================================
 ...
 *    - A: '@/lib/api/quotation-from-workorder-migration'
 * 
 * 3. Reemplaza las funciones:
 *    - createQuotationFromWorkOrder() → createQuotationFromWorkOrderWithLogging()
 * 
