/**
 * Sistema de Configuración Unificado y Robusto
...
const envSchema = z.object({
  ...
  // Backup
  BACKUP_FREQUENCY_HOURS: z.number().default(24),
  BACKUP_RETENTION_COUNT: z.number().default(7),
  ...
  ENABLE_MINIFICATION: z.boolean().default(true),
...
export function getConfig(): AppConfig {
  ...
  try {
    ...
    const rawEnv = {
      ...
      BACKUP_FREQUENCY_HOURS: parseInt(process.env.BACKUP_FREQUENCY_HOURS || '24'),
      BACKUP_RETENTION_COUNT: parseInt(process.env.BACKUP_RETENTION_COUNT || '7'),
